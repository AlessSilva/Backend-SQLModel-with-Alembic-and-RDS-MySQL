...
class InputTicketEdit(BaseModel):
    ...
    #     elif v.isspace():
    #         erro = f'''O campo "titulo" deve ser fomado
    ...
    #     elif not isinstance(v, str):
    #         erro = f'''O campo "descricao" deve ser do
    #         tipo str, mas o tipo fornecido é {type(v).__name__}.'''
    #     elif v.isspace():
    ...
    # @validator('email_usuario', pre=True)
    # def validar_email_usuario(cls, v, values, **kwargs):
    #     erro = None
    ...
    # @validator('nome_usuario', pre=True)
    # def validar_titulo(cls, v, values, **kwargs):
    #     erro = None
    ...
    #         mas o tipo fornecido é {type(v).__name__}.'''
    #     elif v.isspace():
    #         erro = f'''O campo "nome_usuario" deve ser fomado
    #         por caracteres válidos, mas foi fornecido {v}.'''
    ...
    # @validator('email_notificacao', pre=True)
    ...
    #         mas o tipo fornecido é {type(v).__name__}.'''
    #     elif v.isspace():
    #         erro = f'''O campo "area" deve ser fomado
    #         por caracteres válidos, mas foi fornecido {v}.'''
    ...
    #                     'arquivado', 'cancelado']
    #         erro = f'''O campo "status" deve ser fornecido
    #         como {l_status}, mas foi fornecido {v}.'''
    #     if erro:
    #         raise PydanticCustomError(
    #             erro,
    #             'value got "{wrong_value}"',
    ...
    #         except ValueError:
    #             erro = '''O campo "data" deve ser fornecido
    #             no formato ISO datetime (aaaa-mm-ddThh:mm:ss).'''
